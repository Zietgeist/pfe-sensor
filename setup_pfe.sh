                                                                                              ...
                                                                                              sleep $((RANDOM % 5 + 1))
                                                                                                  ...
                                                                                                  if [ -z "$DEVICE_NUM" ]; then
                                                                                                      echo "Could not claim a device number after 10 tries. Check your internet connection and re-run this script."
                                                                                                          ...
                                                                                                          # Each device's own field hotspot is now named "PFE-NET-<n>" (its device
                                                                                                          # number), not a single shared "PFE-NET" — see pressure_display.py. Loop
                                                                                                          # over any matching profiles instead of one hardcoded name so this stays
                                                                                                          # correct as device numbers change.
